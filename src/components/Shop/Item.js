    ...
    return (
        <div className="bg-base-100 shadow-2xl rounded-xl pb-4">
            ...
            <div className="card-body">
                ...
                <p className='flex gap-2 items-center'>BookedMark: <BsFillBookmarkHeartFill className='text-lg cursor-pointer' /></p>
            </div>
            <div className="flex justify-evenly flex-wrap gap-6">
                ...
                <button className="w-[140px] btn  bg-blue-800 border-0">More Info</button>
            </div>
        </div>
    );
};
